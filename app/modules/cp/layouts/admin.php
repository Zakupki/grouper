			...
			<div id="menus_wrapper">
				<div id="main_menu">
					<ul>
						...
						<?} if($this->view->registry->controller=='releases'){?>
							<li><a href="/admin/releases/" class="selected"><span><span>Релизы</span></span></a></li>
						<?}else{?>
							<li><a href="/admin/releases/"><span><span>Релизы</span></span></a></li>
						<?}if($this->view->registry->controller=='news'){?>
							<li><a href="/admin/news/" class="selected"><span><span>Новости</span></span></a></li>
						<?}else{?>
							<li><a href="/admin/news/"><span><span>Новости</span></span></a></li>
						<?}if($this->view->registry->controller=='balance'){?>
							<li><a href="/admin/balance/" class="selected"><span><span>Баланс</span></span></a></li>
						<?}else{?>
							<li><a href="/admin/balance/"><span><span>Баланс</span></span></a></li>
						
						<?}if($this->view->registry->controller=='sites' && $this->view->registry->action=='artist'){?>
							<li><a href="/admin/sites/artist/" class="selected"><span><span>Артисты</span></span></a></li>
						<?}else{?>
							<li><a href="/admin/sites/artist/"><span><span>Артисты</span></span></a></li>
						
						<?}if($this->view->registry->controller=='sites' && $this->view->registry->action=='club'){?>
							<li><a href="/admin/sites/club/" class="selected"><span><span>Клубы</span></span></a></li>
						<?}else{?>
							<li><a href="/admin/sites/club/"><span><span>Клубы</span></span></a></li>
						<?}if($this->view->registry->controller=='brands'){?>
							<li><a href="/admin/brands/" class="selected"><span><span>Бренды</span></span></a></li>
						<?}else{?>
							<li><a href="/admin/brands/"><span><span>Бренды</span></span></a></li>
						<?}if($this->view->registry->controller=='social'){?>
							<li><a href="/admin/social/" class="selected"><span><span>Сети</span></span></a></li>
						<?}else{?>
							<li><a href="/admin/social/"><span><span>Сети</span></span></a></li>
						...
						<?}if($this->view->registry->controller=='geo'){?>
							<li><a href="/admin/geo/" class="selected"><span><span>География</span></span></a></li>
						<?}else{?>
							<li><a href="/admin/geo/"><span><span>География</span></span></a></li>
						<?}if($this->view->registry->controller=='recards'){?>
							<li><a href="/admin/recards/" class="selected"><span><span>Рекард</span></span></a></li>
						<?}else{?>
							<li><a href="/admin/recards/"><span><span>Рекард</span></span></a></li>
						<?}?>
