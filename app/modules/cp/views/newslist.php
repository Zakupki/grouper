											...
											<div class="sct_right">
												...
												<div class="table_wrapper">
													...
													<table cellpadding="0" cellspacing="0" width="100%">
														...
														<? if(is_array($this->view->newslist)){
														...
														<tr class="<?=$linecss[$cnt];?>">
															<td><?=$news['id'];?></td>
															<td class="photo"><a class="product_thumb" href="/admin/new/<?=$news['id'];?>/"><img src="<?=$news['url'];?>"/></a></td>
															<td><a class="product_name" href="/admin/new/<?=$news['id'];?>/"><?=$news['name'];?></a></td>
															<td><a target="_blank" href="http://<?=MAIN_HOST;?>/new/<?=$news['itemid'];?>/">http://<?=MAIN_HOST;?>/new/<?=$news['itemid'];?>/</a></td>
															<td><a href="/admin/user/<?=$news['userid'];?>/"><?=$news['login'];?></a></td>
															<td><a href="/admin/site/<?=$news['siteid'];?>/"><?=$news['siteid'];?></a></td>
															<td><? if($news['recommend']){?><span class="approved">&nbsp;</span><?}?></td>
															<td>
																<!--<div class="actions">
																	<ul>
																		<li><a class="action1" href="#">1</a></li>
																...
																<div class="actions_menu">
																	<ul>
																		...
																		<li><a class="edit" href="/admin/new/<?=$news['id'];?>/">Edit</a></li>
