<h1><?=$this->registry->trans['feedback'];?></h1>
  ...
  <form action="/user/sendfeedback/" method="post" enctype="multipart/form-data">
    ...
    <div class="left">
      ...
      <div class="field-email field">
        <div class="label"><label for="feedback-form-email">E-mail</label></div>
      ...
      <div class="field-subject field">
        <div class="select">
          <div class="label"><label for="feedback-form-subject"><?=$this->registry->trans['subject'];?></label></div>
      ...
      <div class="field-email field">
        ...
        <div class="label"><label for="feedback-form-email">Captcha</label></div>
        <div class="input-text"><div class="r"><div class="l"><input name="user_capcha" id="feedback-form-capcha" type="text" class="required" /></div></div></div>
        <br/>
    ...
    <div class="right">
      ...
      <div class="field-message field">
        ...
        <div class="label"><label for="feedback-form-message"><?=$this->registry->trans['message'];?></label></div>
