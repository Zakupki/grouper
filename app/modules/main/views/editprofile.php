<div class="user-wrap">
  ...
  <div class="h1">
    <h1><?=$this->registry->trans['edit'];?> <?=strtolower($this->registry->trans['profile']);?></h1>
  </div>
    ...
    <?}?>
        ...
        <div class="<?=($this->view->profile['siteid'])?'hidden':'';?> user-info">
          ...
          <div class="row">
            <div class="field-name field">
              <div class="label"><label for="profileName"><?=$this->registry->trans['display_name'];?></label></div>
            ...
            <div class="field-site field">
              <div class="label"><label for="profileSite"><?=$this->registry->trans['personalsite'];?></label></div>
          ...
          <div class="user-info field-about field">
            <div class="label"><label for="profileAbout"><?=$this->registry->trans['aboutme'];?></label></div>
            <div class="textarea">
          ...
          <div class="field-refs field">
            <div class="label"><?=$this->registry->trans['links'];?></div>
            <ul class="refs">
              <? 
        if(is_array($this->view->profile['links'])){
          ...
          <li>
                  ...
                  <div class="hide input-checkbox">
                    ...
                    <label for="profileRefHide<?=$k;?>"><?=$this->registry->trans['hide'];?></label>
                  </div>
                  <div class="remove"><span><?=$this->registry->trans['delete'];?><i class="i"></i></span></div>
                  <div class="drag"></div>
                  <div class="lt"></div><div class="rt"></div><div class="rb"></div><div class="lb"></div>
                </li>
          <?  
        ...
        <li>
                ...
                <div class="hide input-checkbox">
                  ...
                  <label for="profileRefHide0"><?=$this->registry->trans['hide'];?></label>
                </div>
                <div class="remove"><span><?=$this->registry->trans['delete'];?><i class="i"></i></span></div>
                <div class="drag"></div>
                <div class="lt"></div><div class="rt"></div><div class="rb"></div><div class="lb"></div>
        ...
        <div class="submit">
          <div class="<?=($this->view->profile['siteid'])?'hidden':'';?> user-info ref-add-link"><span><?=$this->registry->trans['addlink'];?><i class="i"></i></span></div>
