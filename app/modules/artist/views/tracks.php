<h2><?=$this->view->pagetitle;?><sup><?=$this->view->trackcnt;?></sup></h2>
         ...
         <?
			...
			?>
                ...
                <div class="cover">
					...
					<span class="download_url">/file/getmp3/?f=<?=$track['mp3id'];?>&name=<?=$track['author'];?> - <?=$track['name'];?><?=$track['remix'];?></span>
                </div>
                <div class="details">
                    <span class="download"><?=$track['download'];?></span>
                    <h4><span class="author"><?=$track['author'];?></span> &#151;</h4>
					
                    <h5><span class="title"><?=$track['name'];?><?=$track['remix'];?></span> 
					<? if($track['promocut']){?>
            ...
            <?
            if($cnt==2 && $tcnt<count($this->view->tracklist)){
            $cnt=0;
            ?>
        </li>
        <li class="release-item">
