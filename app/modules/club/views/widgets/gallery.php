<div class="widget">
  <div class="widget-header">
    ...
    <div class="widget-title">
      <h2><a href="/gallery/"><?=$this->view->widgetname;?></a></h2>
  ...
  <div class="widget-content"><div class="widget-content-wrap">
    <div class="galleries">
      ...
      <div class="li">
        <div class="image">
          <a href="/gallery/<?=$gallery['id'];?>/"><img src="<?=$gallery['preview'];?>" alt="<?=$gallery['name'];?>" /></a>
          <i class="i-frame"></i>
          <?
  ...
  <div class="widget-footer">
    <div class="widget-more-link"><a href="/gallery/"><span><?=$this->registry->trans['allalbums'];?></span></a></div>
  </div>
</div>