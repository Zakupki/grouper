<div class="widget">
  <div class="widget-header">
    ...
    <div class="widget-title">
	  ...
	  <h2><a href="/events/"><?=$this->view->widgetname;?></a></h2>
      <?}else{?>
	  <h2><a class="future-events active" href="/events/"><?=$this->registry->trans['coming'];?><i class="i-pointer"></i></a><a class="past-events" href="/events/past/"><?=$this->registry->trans['past'];?></a></h2>
      <?}?>
	</div>
  </div>
  <?=$this->view->teaser;?>
  <div class="widget-content">
    ...
    <div class="events">
      ...
      ?>
      <div class="<?=($cnt)?'events-even ':'';?>events-li">
       <a href="/event/<?=$event['id'];?>/" class="e">
        ...
        ?>
        <span class="controls">
          <i class="i-add"><a href="/admin/event/?date=<?=$event['date_start'];?>"></a></i>
  ...
  <div class="widget-footer">
    <div class="widget-more-link"><a href="/events/"><span><?=$this->registry->trans['allevents'];?></span></a></div>
  </div>
</div>