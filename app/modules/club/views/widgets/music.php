<div class="widget">
  <div class="widget-header">
    ...
    <div class="widget-title">
      <h2><a href="/music/"><?=$this->view->widgetname;?></a></h2>
  ...
  <div class="widget-content"><div class="widget-content-wrap">
    <div class="tracks">
      ...
      <? } ?>
	  <?} 
	  if(tools::int($_SESSION['User']['id'])==tools::int($_SESSION['Site']['userid']) && count($this->view->tracks)<1) {
	  ?>
  ...
  <div class="widget-footer">
    <div class="widget-more-link"><a href="/music/"><span><?=$this->registry->trans['allmusic'];?></span></a></div>
  </div>
</div>