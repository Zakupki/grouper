<div class="widget">
  <div class="widget-header">
    ...
    <div class="widget-title">
      <h2><a href="/palce/"><?=$this->view->pagename;?></a></h2>
      <? if(!$this->view->teaser){?>
  ...
  <div class="widget-content-no-footer widget-content"><div class="widget-content-wrap">
    ...
    <div class="place-open place">
      <? if($this->view->place['gallerytypeid']>0){?>
      ...
      <div class="descr">
        ...
        <div class="location"><a href="<?=$this->view->place['maplink'];?>"><?=$this->view->place['address'];?><i class="i"></i></a></div>
        <?}?>
        <? if($this->view->place['about']){?>
        <div class="text">
          <p>
            <?=$this->view->place['about'];?>
          </p>
        </div>
        <?}else{?>
