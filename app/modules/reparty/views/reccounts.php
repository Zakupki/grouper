          ...
          <form action="/reccounts/buy/" method="post">
            ...
            <div class="settings-buy settings rc">
              ...
              <div class="fieldset-period fieldset-even fieldset">
                <div class="title">Срок работы (месяцы):</div>            
                <div class="field">
                  <div class="label"><label for="settings-period">Добавить</label></div>
              ...
              <div class="fieldset-quota fieldset">
                ...
                <div class="field-quota field">
                  <div class="label"><label for="settings-quota">Добавить</label></div>
              ...
              <div class="fieldset-submit fieldset-even fieldset">
                ...
                <div class="button"><div class="r"><div class="l"><button type="submit" class="{$buyButtonClass}">Купить</button></div> </div></div>
              </div>
