  ...
  <form action="/cabinet/sendsupport/" method="post" enctype="multipart/form-data">
    ...
    <div class="left">
      ...
      <div class="field-subject field">
        <div class="select">
          <div class="label">
            <label for="support-form-subject">Тема</label>
          </div>
    ...
    <div class="right">
      ...
      <div class="field-message field">
        ...
        <div class="label">
          <label for="support-form-message">Сообщение</label>
        </div>
...
<div class="support-requests">
  <h2>Мои обращения в службу поддержки</h2>

  <table>
  <tr>
    <th class="num">№ опер.</th>
    <th class="date">Дата / время</th>
    <th class="qa">Вопрос / Ответ</th>
  </tr>
  <?
