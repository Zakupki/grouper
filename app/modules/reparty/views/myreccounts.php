...
OUT;
    ...
    <div class="<?=$teaserAct;?>teaser" id="content-teaser<?=$site['id'];?>">
        <a href="/cabinet/myreccounts/#content<?=$site['id'];?>" id="content<?=$site['id'];?>">
          ...
          <span class="text">
            <span>Занято <em><?=sizeFormat($filespace['size']);?></em> из <em><?=$this->view->sitedisc[$site['id']];?> ГБ</em></span>
            <span>До <?=$this->view->Tools->GetDate($site['date_end']);?><?=($this->view->Tools->GetDate($site['date_end'])!='сегодня')?' года':'';?>.</span>
          </span>
      <?=$ss_teaserHTML;?>
        ...
        <form action="/cabinet/prolong/" method="post">
          ...
          <? } ?>
            ...
            <div class="fieldset-period fieldset-even fieldset">
              <div class="title">
                <h3>Срок работы (месяцы):</h3>
              </div>
              <div class="field-period field">
                <div class="label"><label for="buy-period<?=$site['id'];?>">Добавить</label></div>
                <? if($site['free']){?>
            ...
            <div class="fieldset-quota fieldset">
              ...
              <div class="field-quota field">
                <div class="label"><label for="buy-quota<?=$site['id'];?>">Добавить</label></div>
                <? if($site['free']){?>
				<div class="input-text-disabled input-text"><div class="r"><div class="l">
...
-->
              ...
              <div class="button"><div class="r"><div class="l"><button>Продлить</button></div> </div></div>
            </div>
            <div class="rc-lt"></div><div class="rc-rt"></div><div class="rc-rb"></div><div class="rc-lb"></div>
          </div>
        </form>
        ...
        <div class="settings-kind settings rc">
          <div class="fieldset-kind fieldset-first fieldset">
            <form action="/cabinet/setkind/" method="post">
              ...
              <div class="title">
                <h3>Мой статус &mdash; <?=$site['sitetypename'];?></h3>
                <div class="help-link"><a href="/help/" target="_blank"><img src="/img/reactor/px.gif" alt="" /></a></div>
              </div>
              ...
              <div class="content">
                <div class="content-wrap">
                  <?=$siteKindHTML;?>
                  <div class="submit">
                    <div class="button"><div class="r"><div class="l"><button type="submit">Изменить статус</button></div></div></div>
                  </div>
                </div>
              </div>
            </form>    
            ...
            <form action="/cabinet/transfer/" method="post">
              ...
              <div class="content">
                <div class="content-wrap">
                  ...
                  <div class="submit">
                    <div class="button"><div class="r"><div class="l"><button type="submit">Передать реккаунт</button></div></div></div>
                  </div>
                </div>
              </div>
            </form>    
