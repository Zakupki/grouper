...
Class Brands_Controller Extends BaseAdmin_Controller {
		...
		function requestsitesAction() {
			$this->sitelist=$this->Brand->getBrandRequestSites($_GET['datatypeid'],$_GET['id']);
			$this->content =$this->view->AddView('brandrequestsites', $this);
			$this->view->renderLayout('admin', $this);
		}
		...
		function brandinnerAction() {
			...
			$this->brandlist=$this->Brand->getBrandOptions();
