										...
										<div class="sct_left">
											<div class="sct_right">
														...
														<? if(is_array($this->view->sitelist)){
															...
															foreach($this->view->sitelist as $site){
																...
																<tr class="<?=$linecss[$cnt];?>">
																	<td><?=$site['id'];?></td>
																	<td><a class="product_name" href="/admin/geo/city/<?=$site['id'];?>/"><?=$site['name'];?></a></td>
																	<td>
																		<div class="actions_menu" style="width: 40px;">
																			<ul>
																				<li><a class="edit" href="/admin/geo/city/<?=$site['id'];?>/">Edit</a></li>
																			</ul>
																		</div>
																	</td>
																</tr>
												...
												<div class="table_menu">
													...
													<ul class="left">
														<li><a href="/admin/geo/city/" class="button add_new"><span><span>Добавить</span></span></a></li>
													</ul>
													<!--<ul class="right">
