...
class odnoklassnikisdk{
    ...
    private static $app_id = "1090049792";
    private static $app_public_key = "CBAINJPBEBABABABA";
    private static $app_secret_key = "1B55E10B9E241DF12DB7452F";
    private static $redirect_url = "http://reactor-pro.com/test/od";
    ...
    public static function makeRequest($methodName, $parameters = null){
        ...
        echo self::$API_REQUSET_ADDRESS . "?" . $requestStr;
